    ...
    for ttl in range(1, MAX_HOPS):
        for tries in range(TRIES):
            ...
            try:
                ...
                type, code, checksum, packetID, sequence = struct.unpack("bbHHh", icmpHeaderData)
                ...
                #try to fetch the hostname
                    ...
                    name_or_ip = '{0} (host name could not be determined)'.format(host_ip)
                    #return name_or_ip
